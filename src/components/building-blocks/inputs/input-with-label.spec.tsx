...
describe('Testing InputWithLabel component', () => {
  it('should render the label correctly', () => {
    render(<InputWithLabel label="Test Label" type="text" />) // ARRANGE
  ...
  it('should render the input with correct type', () => {
    render(<InputWithLabel label="Test Label" type="password" />) // ARRANGE
  ...
  it('should apply the correct placeholder', () => {
    render(
      <InputWithLabel label="Test Label" type="text" placeHolder="Enter text" />
    ) // ARRANGE
    const inputElement = screen.getByLabelText('Test Label') // ACT
